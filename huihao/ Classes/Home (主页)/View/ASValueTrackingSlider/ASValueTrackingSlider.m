...
- (void)setup
{
    ...
    UIImage *stetchLeftTrack=[UIImage imageNamed:@"rating_on"];
    //设置滑块的样式
    [self setMinimumTrackImage:stetchLeftTrack forState:UIControlStateNormal];
    //注意这里要加UIControlStateHightlighted的状态，否则当拖动滑块时滑块将变成原生的控件
    [self setThumbImage:stetchLeftTrack forState:UIControlStateHighlighted];
    
    [self setThumbImage:stetchLeftTrack forState:UIControlStateNormal];
